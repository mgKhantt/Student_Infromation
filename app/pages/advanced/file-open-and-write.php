            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">File Open and Write</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php 
                                #write file
                                $file = fopen("./write-file.txt", "a") or die("Unable to acces the file");
                                fwrite($file,"Khant Phone Naing\n");
                                fwrite($file, "CodeCrafters\n");
                                fclose($file);

                                #read file
                                $file = fopen("./write-file.txt", "r") or die("Unable to read file");
                                while(!feof($file)) {
                                    echo fgets($file) . "<br>";
                                }
                                fclose($file);
