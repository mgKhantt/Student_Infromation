            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">File Open and Read</h1>
                        
                    </div>

                    <div class="row">
                        <div class="col-md-12">
                            <h3>Read the whole file</h3>
                            <?php
                                $file = fopen("./read-file.txt", "r") or die("Unable to access the file");
                                echo fread($file,filesize("./read-file.txt")) . "<br>";
                                fclose($file);
                            ?>
                            ...
                            <h3>Read character by character</h3>
                            <?php 
                                $file = fopen("./read-file.txt", "r") or die("Unable to access the file");
                                while(!feof($file)) {
                                    echo fgetc($file) . " || ";
