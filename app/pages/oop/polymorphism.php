            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Polymorphism</h1>
                            ...
                            <?php 
                              class Car {
                                ...
                                public function drive() {
                                    echo "{$this->brand} is drving.<br>";
                                }

                                public function stop() {
                                    echo "{$this->brand} is stopping.<br>";
                                }
                              }
                              ...
                              class Engine {
                                ...
                                public function engineStart() {
                                    echo "{$this->brand} engine starts.<br>";
                                }

                                public function enginerStop() {
                                    echo "{$this->brand} engine stops.<br>";
                                }
                              }
                              ...
                              class Wheel {
                                ...
                                public function spin() {
                                    echo "{$this->brand} is spinning.<br>";
                                }
                              }

                              $suzukiWheel = new Wheel("Stone", 21);
                              $suzukiEngine = new Engine("V8", 350);
