            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Abstract</h1>
                        ...
                        <div class="col-md-12">
                            <?php 
                                abstract class ParentClass {
                                    public $parentName = "U Ba and Daw Hla";

                                    public function getProperty() {
                                        echo "Parent give property to child<br>";
                                    }

                                    abstract public function tryToGetDegree();
                                    abstract public function tryToGetMarried();
                                }
                                ...
                                class ChildClass extends ParentClass {
                                    ...
                                    public function tryToGetDegree() {
                                        echo "{$this->name} accomplished the degree<br>";
                                    }

                                    public function tryToGetMarried() {
                                        echo "{$this->name} is geeting married";
                                    }
                                }

                                $mgmg = new ChildClass("mg mg");
                                $mgmg->tryToGetDegree();
                                $mgmg->getProperty();
                                $mgmg->tryToGetMarried();
                            ?>
                        </div>
                    </div>
